...
$(document).ready(function () {
  ...
  var orderActivityChartOptions = {
    ...
    series: [
      {
        data: [40, 60, 120, 100, 140, 80, 180, 180, 280, 190, 210, 190],
      },
    ],
    markers: {
      size: 5,
  ...
  if ($(".widget-user-details .table-responsive").length > 0) {
    var user_details = new PerfectScrollbar(
  ...
  if ($(".widget-overlay-content .table-responsive").length > 0) {
    var card_overlay = new PerfectScrollbar(
  ...
  if ($(".widget-earnings-scroll").length > 0) {
    var widget_earnings = new PerfectScrollbar(
...
function widgetMessageSend(source) {
  ...
  if (message != "") {
    var html =
      '<div class="chat"><div class="chat-body"><div class="chat-message">' +
      "<p>" +
      message +
      "</p>" +
      "<div class=" +
      "chat-time" +
      ">3:35 AM</div></div></div></div>";
