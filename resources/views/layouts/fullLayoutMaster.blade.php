...
<html class="loading" lang="en" data-textdirection="ltr">
  ...
  <head>
    ...
    <title>@yield('title') - Beverages System</title>
  ...
  <!-- BEGIN: Body-->
  <body style="overflow: hidden!important;" class="vertical-layout 1-column navbar-sticky {{$configData['bodyCustomClass']}} footer-static blank-page
