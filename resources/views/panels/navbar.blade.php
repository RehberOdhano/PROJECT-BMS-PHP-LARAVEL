            ...
            <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
              {{-- <li class="dropdown-menu-header">
                <div class="dropdown-header px-1 py-75 d-flex justify-content-between"><span
                    class="notification-title">7 new Notification</span><span class="text-bold-400 cursor-pointer">Mark
                    all as read</span></div>
              </li> --}}
              <li class="scrollable-container media-list"><a class="d-flex justify-content-between"
                ...
                {{-- <div class="d-flex justify-content-between cursor-pointer">
                  <div class="media d-flex align-items-center py-0">
                    <div class="media-left pr-0"><img class="mr-1" src="{{asset('images/icon/sketch-mac-icon.png')}}"
                        alt="avatar" height="39" width="39"></div>
                    <div class="media-body">
          ...
          <li class="dropdown dropdown-user nav-item">
            ...
            <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
              <div class="user-nav d-sm-flex d-none">
                ...
                <span class="user-status badge badge-danger">SuperAdmin</span>
              </div>
              <span><img class="round" src='{{asset("/images/profile_bg.jpg")}}' alt="avatar" height="40"
                  width="40"></span>
            </a>
            <div class="dropdown-menu dropdown-menu-right pb-0">
              ...
              <a class="dropdown-item" href="/logout/{{Session()->get('superadmin')['role']}}"><i
            ...
            <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
              <div class="user-nav d-sm-flex d-none">
                ...
                <span class="user-status badge badge-warning">Admin</span>
              </div>
              <span><img class="round" src='{{asset("/images/profile_bg.jpg")}}' alt="avatar" height="40"
                  width="40"></span>
            </a>
            <div class="dropdown-menu dropdown-menu-right pb-0">
              <a class="dropdown-item" href="/dists/admin/profile">
                <i class="bx bx-user mr-50"></i>Profile
              </a>
              <div class="dropdown-divider mb-0"></div>
              <a class="dropdown-item" href="/logout/{{Session()->get('admin')['role']}}"><i
                  class="bx bx-power-off mr-50"></i> Logout</a>
            </div>
            ...
            <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
              <div class="user-nav d-sm-flex d-none">
                ...
                <span class="user-status badge badge-primary">User</span>
              </div>
              <span><img class="round" src='{{asset("/images/profile_bg.jpg")}}' alt="avatar" height="40"
                  width="40"></span>
            </a>
            <div class="dropdown-menu dropdown-menu-right pb-0">
              ...
              <div class="dropdown-divider mb-0"></div>
              <a class="dropdown-item" href="/logout/{{Session()->get('user')['role']}}"><i
                  class="bx bx-power-off mr-50"></i> Logout</a>
            </div>
            @endif
          </li>
