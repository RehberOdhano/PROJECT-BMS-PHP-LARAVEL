...
class MenuServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        $superAdminMenuJson = file_get_contents(base_path('resources/data/menus/super-admin-menu.json'));
        $superAdminData = json_decode($superAdminMenuJson);
        ...
        \View::share('menuData', [$verticalMenuData, $horizontalMenuData, $verticalMenuBoxiconsData, $superAdminData]);
    }
}
