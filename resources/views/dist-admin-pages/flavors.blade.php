  ...
  <div class="row">
    <div class="col d-flex justify-content-between">
      ...
      <button type="button" class="btn btn-success glow mr-1 mb-1" data-toggle="modal" data-target="#add"><i
          class="bx bx-plus"></i>
        <span class="align-middle ml-25">Add Flavor</span></button>
    </div>
  </div>
</section>
            ...
            <table class="table zero-configuration">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>{{date('d-m-Y', strtotime(substr($flavor["created_at"], 0, 10)))}}</td>
                  <td class="text-center py-1">
                    <div class="dropup">
                      ...
                      <div class="dropdown-menu dropdown-menu-right">
                        <a class="dropdown-item" href="" data-target="#edit-flavor-<?php echo $flavor['id']; ?>"
                          data-toggle="modal"><i class="bx bx-edit-alt mr-1"></i> edit</a>
                        <a class="dropdown-item" id="confirm-text" href=""
                          data-target="#delete-<?php echo $flavor['id']; ?>" data-toggle="modal"><i
                  ...
                  <div class="modal-success mr-1 mb-1 d-inline-block">
                    <!--Success theme Modal -->
                    <div class="modal fade text-left" id="edit-flavor-<?php echo $flavor['id']; ?>" tabindex="-1"
                      role="dialog" aria-labelledby="myModalLabel110" aria-hidden="true">
                      <div class="modal-dialog  modal-dialog-centered modal-dialog-scrollable">
                        <div class="modal-content">
                          <div class="modal-header bg-success">
                            <h5 class="modal-title white" id="myModalLabel110">Edit Flavor</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                              <i class="bx bx-x"></i>
                            </button>
                          </div>
                          <div class="modal-body">
                            <form id="flavorForm{{$flavor['id']}}" method="POST"
                              action="{{URL('/dists/admin/edit/flavor/'.$flavor['id'])}}">
                              @csrf
                              <div class="form-body">
                                <div class="row">
                                  <div class="col-md-12 col-12">
                                    <div class="form-group form-field">
                                      <label for="name{{$flavor['id']}}">Flavor Name</label>
                                      <input type="text" id="name{{$flavor['id']}}" class="form-control"
                                        value="{{$flavor['flavor_name']}}" name="flavor_name"
                                        onkeyup="checkFlavorName(this)"
                                        onfocusout="checkInputField(this, {{$flavor['id']}})">
                                      <small></small>
                                    </div>
                                  </div>
                                  <div class="col-12 d-flex justify-content-end">
                                    <button onclick="submitFlavorForm({{$flavor['id']}})" type="submit"
                  ...
                  {{-- delete flavor modal --}}
                  <div class="modal fade text-left" id="delete-<?php echo $flavor['id']; ?>" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                      <div class="modal-content">
                        ...
                        <div class="modal-body text-center">
                          <form class="form" action="{{URL('/dists/admin/delete/flavor/'.$flavor['id'])}}"
                            method="POST">
                            @csrf
                            <div class="form-body">
                              <div class="row">
                                <div class="col-md-12 col-12">
                                  <div class="form-label-group">
                                    <p style="font-size: 20px; font-weight: bold">If you delete this flavor, then the
                                      related products will also be deleted.
                                    </p>
                                    <p style="font-size: 20px; font-weight: bold">Are you sure you want to delete this?
                                    </p>
                                    <input name="delete_flavor" type="hidden" id="delete_flavor" class="form-control"
                                      value="{{$flavor['id']}}">
                                  </div>
                                </div>
                                <div class="col-12 d-flex justify-content-end">
...
<div class="modal-success mr-1 mb-1 d-inline-block">
  ...
  <div class="modal fade text-left" id="add" tabindex="-1" role="dialog" aria-labelledby="myModalLabel110"
    ...
    <div class="modal-dialog  modal-dialog-centered modal-dialog-scrollable">
      <div class="modal-content">
        <div class="modal-header bg-success">
          <h5 class="modal-title white" id="myModalLabel110">Add Flavor</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <i class="bx bx-x"></i>
          </button>
        </div>
        <div class="modal-body">
          <form id="flavorForm{{-1}}" class="form" method="POST" action="/dists/admin/add/flavor">
            @csrf
            <div class="form-body" id="add-flavor-row">
              <div class="row">
                <div class="col-md-8 col-8">
                  <div class="form-group form-field">
                    <label for="name{{-1}}">Enter Flavors</label>
                    <input type="text" id="name{{-1}}" class="form-control" placeholder="Flavor Name"
                      name="flavor_names[]" onkeyup="checkFlavorName(this)" onfocusout="checkInputField(this, {{-1}})">
                    <small></small>
                  </div>
                </div>
              ...
              <div class="row">
                <div class="col-12 d-flex justify-content-end">
                  <button onclick="submitFlavorForm({{-1}})" type="submit" class="btn btn-success mr-1">Add
                    Flavor</button>
...
<script src="{{asset('js/addEditFlavour.js')}}"></script>
<script>
  function add_row() {
    var id = Math.floor(Math.random() * 10001);
    var parentElement = document.getElementById("add-flavor-row");
    ...
    input.name = "flavor_names[]";
    input.placeholder = "Flavor Name";
    input.setAttribute("onkeyup", "checkFlavorName(this)");
