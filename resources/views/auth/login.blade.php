            ...
            <div class="card-body">
              ...
              <div class="divider">
                <div class="divider-text text-uppercase text-muted">
                  <small>login with your registered email</small>
                </div>
              </div>
              @if(session('message'))
              ...
              @endif
              {{-- form  --}}
              <form id="login" class="form" method="POST" action="/login">
                @csrf
                <div class="form-group mb-50 form-field">
                ...
                <div class=" form-field form-group d-flex flex-md-row flex-column justify-content-between align-items-center">
                  <div class="text-left">
              ...
              {{-- <div class="text-center">
                ...
                <a href="/bms/register"><small>Sign up</small></a>
              </div> --}}
            </div>
          </div>
        </div>
